...
class System
{
	...
	static void EventLMStoreLoadHandler(esim::Event *, esim::Frame *);
	static void EventLMStoreStoreHandler(esim::Event *, esim::Frame *);
	static void EventLMStoreFindAndLockHandler(esim::Event *, esim::Frame *);
	static void EventLMStoreAllocHandler(esim::Event *, esim::Frame *);
	static void EventLMStoreDeallocHandler(esim::Event *, esim::Frame *);
	...
	Module *ConfigReadLMStore(misc::IniFile *ini_file,
			const std::string &section);

	void ConfigReadL1Cache(misc::IniFile *ini_file);
...
public:
	...
	static esim::Event *event_lmstore_load;
	static esim::Event *event_lmstore_load_lock;
	static esim::Event *event_lmstore_load_action;
	static esim::Event *event_lmstore_load_unlock;
	static esim::Event *event_lmstore_load_finish;

	static esim::Event *event_lmstore_store;
	static esim::Event *event_lmstore_store_lock;
	static esim::Event *event_lmstore_store_action;
	static esim::Event *event_lmstore_store_unlock;
	static esim::Event *event_lmstore_store_finish;

	static esim::Event *event_lmstore_find_and_lock;
	static esim::Event *event_lmstore_find_and_lock_port;
	static esim::Event *event_lmstore_find_and_lock_action;
	static esim::Event *event_lmstore_find_and_lock_finish;

	static esim::Event *event_lmstore_alloc;
	static esim::Event *event_lmstore_alloc_lock;
	static esim::Event *event_lmstore_alloc_action;
	static esim::Event *event_lmstore_alloc_process;
	static esim::Event *event_lmstore_alloc_unlock;
	static esim::Event *event_lmstore_alloc_finish;

	static esim::Event *event_lmstore_dealloc;
	static esim::Event *event_lmstore_dealloc_lock;
	static esim::Event *event_lmstore_dealloc_action;
	static esim::Event *event_lmstore_dealloc_process;
	static esim::Event *event_lmstore_dealloc_unlock;
	static esim::Event *event_lmstore_dealloc_finish;
